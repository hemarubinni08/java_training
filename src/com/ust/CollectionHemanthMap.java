...
public class CollectionHemanthMap {
    public void printMap(Map<String, String> batchNames, Map<String, String> newMap1) {
    ...
    public void removeDuplicateMap(Map<String, String> batchNames, Map<String, String> batchNames1) {
        ...
        batchNames.entrySet().stream().
                filter(entry -> (batchNames1.containsKey(entry.getKey())
                || batchNames1.containsValue(entry.getValue()))).
                forEach(entry -> temporaryMap.put(entry.getKey(), entry.getValue()));
        resultMap.entrySet().stream().
                filter(entry -> !(temporaryMap.containsKey(entry.getKey()) || temporaryMap.containsValue(entry.getValue()))).
