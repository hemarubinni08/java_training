...
public class CollectionSetKvNew {
    public static void collectionSetIterations(Set<String> set1) {
    ...
    public static void hashIteration(Set<String> set1) {
        ...
        public static void getNonDuplicate (Set<String> set1, Set< String >set2){
    ...
    public static Set<String> removeDuplicateSet(Set<String> set1, Set<String> set2) {
