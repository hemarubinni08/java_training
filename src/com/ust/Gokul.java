...
public class Gokul {
    public static void main(String[] args) {
        ...
        Operation arith=new Operation();
        System.out.println(arith.addition(2.5,3.5));
//        CarAbstractGokul car=new  CarAbstractGokul();
//        BikeAbstractGokul bike=new BikeAbstractGokul();
//        BusAbstractGokul bus=new BusAbstractGokul();
//        TruckAbstractGokul truck=new TruckAbstractGokul();
...
//        System.out.println("Car has a Gear:" +car.hasGears());
...
//        System.out.println("Bike has a Gear:" +bike.hasGears());
...
//        System.out.println("Bus has a Gear:" +bus.hasGears());
//        System.out.println("Truck Wheels:" + bus.numberOfWheels());
//        System.out.println("Truck Speed:" + bus.maximumSpeed());
//        System.out.println("Truck seats: " +bus.seatAvailable());
//        System.out.println("Truck has a Gear:" +bus.hasGears());
