...
public class CollectionHashMapKv {
    ...
    public static void doIteration(HashMap<String, String> newMap, HashMap<String, String> newMap1) {
        HashMap<String, String> mergedMap = new HashMap<>();
        HashMap<String, String> temporaryMap = new HashMap<>();
        mergedMap.putAll(newMap);
        mergedMap.putAll(newMap1);
        HashMap<String, String> resultMap = new HashMap<>();
        for (Map.Entry<String, String> keyValues : mergedMap.entrySet()) {
            if (!((newMap.containsKey(keyValues.getKey()) && newMap1.containsKey(keyValues.getKey())) ||
                    (newMap.containsValue(keyValues.getValue()) && newMap1.containsValue(keyValues.getValue())))) {
